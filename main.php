...
<head>
    ...
    <script>
        ...
        fbq('init', '2305150303080362');
        fbq('track', 'PageView');
    </script>
    <noscript>
        <img height="1" width="1" style="display:none"
             src="https://www.facebook.com/tr?id=2305150303080362&ev=PageView&noscript=1"/>
    </noscript>
    ...
    <div class="container">
        <div class="header-wrap">
            ...
            <div class="header_lang">
                <a class="lang-link <?php if( $lang == 'ua') echo 'act'?>" href="/lang/ua" >UA</a>
                <span>|</span>
                <a class="lang-link <?php if( $lang == 'ru') echo 'act'?>" href="/lang/ru">RU</a>
            </div>
        </div>
    </div>
</header>
<div class="katalog" style="font-family: 'MontserratBold'; font-size: 20px; color: #252525; text-align: center; margin-top: 17px;">
  <div class="sec-color_wrap">
      <h2><?php echo($contentText["katalog"][$lang]) ?></h2>
    </div>
  </div>
        ...
        <div class="top_wrap">
            <div class="left-sec">
              <?php foreach ($products as $key => $item) { ?>
                <div class="hidden" id="product-main-info-<?php echo $key ?>">
                    <h1><?php echo($item["name"][$lang]) ?></h1>
                    <div class="wrapper">
                        ...
                        <div class="top-price des">
                            <div class="old-price">
                                ...
                                <span class="value"><?php echo($item['topImages']["oldPrice"]) ?></span>
                            </div>
                            <div class="discount">
                                <span class="text"><?php echo($contentText["sale"][$lang]) ?></span>
                                <span class="value"><?php echo($item['topImages']["sale"]) ?></span>
                            </div>
                            <div class="current-price">
                                <span class="text"><?php echo($contentText["todayPrice"][$lang]) ?>:</span>
                                <span class="value"><?php echo($item['topImages']["newPrice"]) ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <a class="btn-color" href="/<?php echo ($lang . '/' . $key)?>"><?php echo($contentText["orderTextmain"][$lang]) ?></a>
                    <div class="top_count"><?php echo($contentText["left"][$lang]) ?> <span><?php echo($item['topImages']["quantity"]) ?></span> <?php echo($contentText["itemsSale"][$lang]) ?>!</div>
                </div>
                <?php } ?>
            </div>
            <div class="right-sec">
                <?php foreach ($products as $key => $item) { ?>
                    <div class="hidden" id="product-right-info-<?php echo $key ?>">
                    <div class="title-mob"><?php echo($item["name"][$lang]) ?></div>
                    <div class="wrap-img">
                        <img src="/<?php echo($item['topImages']["topImgUrl"]) ?>" alt="">
                        <div class="label"><?php echo($item['topImages']["textLabel"][$lang]) ?></div>
                        <div class="table-size">
                            <div class="text"><?php echo($contentText["sizes"][$lang]) ?></div>
                            <div class="num"><?php echo($item['topImages']["textSizeVal"]) ?></div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <?php foreach ($products as $key => $item) { ?>
                            <div class="swiper-slide" onclick="
                                console.log('changed' , '<?php echo $key ?>');
                                   <?php foreach ($products as $removeKey => $removeItem) { ?>
                                      document.getElementById('product-main-info-<?php echo $removeKey ?>').classList.add('hidden');
                                      document.getElementById('product-right-info-<?php echo $removeKey ?>').classList.add('hidden');
                                   <?php } ?>
                                    document.getElementById('product-main-info-<?php echo $key ?>').classList.remove('hidden');
                                    document.getElementById('product-right-info-<?php echo $key ?>').classList.remove('hidden');
                                    ">
                                <img data-color="<?php echo($key) ?>" class="url-load" data-way="/<?php echo($item['topImages']["topImgUrl"]) ?>"
                                     src="" alt="">
                            </div>
                            <?php if ($i == 0) { ?>
                                <script>
                                    console.log('initiated', '<?php echo $key ?>');
                                    document.getElementById('product-main-info-<?php echo $key ?>').classList.remove('hidden');
                                    document.getElementById('product-right-info-<?php echo $key ?>').classList.remove('hidden');
                                </script>
                            <?php } ?>
    ...
    <div class="container">
        <div class="sec-style_wrap">
            <div class="style-slider">
                <div class="title-mob"><?php echo($contentText["liveDresses"][$lang]) ?></div>
                <div class="style-slider-item swiper-container">
                    <div class="swiper-wrapper">
                        <?php foreach ($products as $item) {
                            $color = array_shift($item['colors']);
                            ?>
                            <div class="swiper-slide" data-num="<?php echo($color["number"]) ?>">
                                <video controls="true" width="100%" height="100%" loop="" muted="" playsinline
                                    ...
                                    <source class="video_source" data-way="/<?php echo($color['videoUrl']) ?>" src="/<?php echo($color['videoUrl']) ?>"
                                            type="video/mp4">
                                </video>
                            </div>
                        <?php } ?>
...
<div class="sec-colors">
    <div class="container">
        <div class="sec-color_wrap">
            <h2><?php echo($contentText["chooseYourDress"][$lang]) ?></h2>
                ...
                <?php foreach ($products as $id => $item) {
                    ...
                    <div class="item-color">
                        <div class="item-color-img">
                            <div class="wrap-img">
                                <img class="url-load" data-way="/<?php echo($color['imgs']['img1']) ?>" src="" alt="" style="max-height: 700px">
                            ...
                            <div class="color-slider color-slider-<?php echo($color['number']) ?> swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <?php foreach ($item['colors'] as $itemImg) { $img = array_shift($itemImg['imgs'])?>
                                        <div class="swiper-slide">
                                            <div class="label"><?php echo($itemImg["sale"]) ?></div>
                                            <div class="table-size">
                                                <div class="text"><?php echo($contentText["sizes"][$lang]) ?></div>
                                                <div class="num"><?php echo($itemImg["sizeText"]) ?></div>
                                            </div>
                        ...
                        <div class="item-color-text">
                            <div class="wrapper-item">
                                <div class="wrapper-one">
                                    <div class="color" style="text-transform: uppercase"><?php echo($item["name"][$lang]) ?></div>
                                    <div class="akcia">
                            ...
                            <a class="btn-color" href="/<?php echo ($lang) . '/' . $id ?>" data-num="<?php echo($color["number"]) ?>"
                                 data-color="<?php echo($color["id"]) ?>" ><?php echo($contentText["orderTextmain"][$lang]) ?></a>
                        </div>
                    </div>
                <?php } ?>
            </div>
    ...
    <div class="container">
        <div class="reviews_wrap">
            <div class="top">
                ...
                <div class="text">
                    <?php echo($contentText["moreThanStart"][$lang]) ?> <span>94,5%</span> <?php echo($contentText["moreThanEnd"][$lang]) ?>
                </div>
                <div class="rating">
            ...
            <div class="popap-table-item">
                ...
                <form action="/<?php echo $_SESSION['lang'] ?>/request-phone" method="post">
                    <label class="name">
                        ...
                        <input class="inp" type="text" name="name" placeholder="<?php echo($contentText["nameInput"][$lang]) ?>" required="">
                    </label>
                    <label class="phone" style="margin-bottom: 25px;">
                        <img class="url-load" data-way="/img/img-30.svg" src="" alt="">
                        <input class="inp inp-phone" type="tel" name="phone" placeholder="<?php echo($contentText["phoneInput"][$lang]) ?>"
                               required="">
                    </label>
                    <input class="btn-color" type="submit" value="<?php echo($contentText["waitingForPhone"][$lang]) ?>">
                </form>
